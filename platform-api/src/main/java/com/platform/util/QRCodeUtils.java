...
public class QRCodeUtils {
	...
	public static String getToken() {
		try {
			...
			map.put("appid", "wx3162b692c201b28d");// 改成自己的appid
			map.put("secret", "e0c4003123852db12f770000dac5f6cf");

			String result = UrlUtilA.sendPost("https://api.weixin.qq.com/cgi-bin/token", map);
